...
public class SkierServicesImpl implements ISkierServices {
    ...
    //
    @Override
    public Skier updateSkier(Long numSkier, Skier skierDetails) {
        Skier skier = skierRepository.findById(numSkier).orElse(null);
        if (skier != null) {
            skier.setFirstName(skierDetails.getFirstName());
            skier.setLastName(skierDetails.getLastName());
            skier.setDateOfBirth(skierDetails.getDateOfBirth());
            skier.setCity(skierDetails.getCity());
            skier.setSubscription(skierDetails.getSubscription());
            return skierRepository.save(skier);
        }
        return null;
    }
    ...
    @Override
    public List<Skier> retrieveSkiersByCity(String city) {
