...
public class SkierRestController {
    ...
    // fonction
    @Operation(description = "Update Skier Information")
    @PutMapping("/update/{numSkier}")
    public Skier updateSkier(@PathVariable("numSkier") Long numSkier, @RequestBody Skier skierDetails) {
    ...
    public List<Skier> getSkiersByCity(@PathVariable("city") String city) {
        return skierServices.retrieveSkiersByCity(city);
    }

    @Operation(description = "Count Skiers by Subscription Type")
    @GetMapping("/countBySubscription/{typeSub}")
    public long countSkiersBySubscription(@PathVariable("typeSub") TypeSubscription typeSubscription) {
        return skierServices.countSkiersBySubscriptionType(typeSubscription);
    }
}
